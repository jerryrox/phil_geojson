 ...
 */
function extract(files, propFileName, extractProperties, getNewSourceGeojsonName, getFeatureGeojsonName) {
    var allProperties = [];
...
extract(getJsonFilesFrom("0_region"), "_regions_properties", function (feature) {
    ...
    return {
        ...
        regionsUrl: getHostedGeojsonUrl("regions_".concat(countryId)),
        geojsonUrl: getHostedGeojsonUrl("region_".concat(id)),
    };
}, function (allProperties) {
    return "regions_".concat(allProperties[0].countryId);
}, function (properties) {
...
extract(getJsonFilesFrom("1_provinces"), "_provinces_properties", function (feature) {
    ...
    return {
        ...
        regionId: regionId,
        center: getCenterPoint(feature.geometry.coordinates),
        regionsUrl: getHostedGeojsonUrl("provinces_".concat(regionId)),
        geojsonUrl: getHostedGeojsonUrl("province_".concat(id)),
    };
}, function (allProperties) {
    return "provinces_".concat(allProperties[0].regionId);
}, function (properties) {
...
extract(getJsonFilesFrom("2_municities"), "_municities_properties", function (feature) {
    ...
    return {
        ...
        center: getCenterPoint(feature.geometry.coordinates),
        regionsUrl: getHostedGeojsonUrl("municities_".concat(provinceId)),
        geojsonUrl: getHostedGeojsonUrl("municity_".concat(id)),
    };
}, function (allProperties) {
    return "municities_".concat(allProperties[0].provinceId);
}, function (properties) {
